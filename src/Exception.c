...
struct ObjException InternalChainingHashTableSizeException = {.message = "Exception in Hash table Create. invalid size!	", .code = __InternalChainingHashTableSizeException__};
